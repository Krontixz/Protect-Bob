...
gdjs.MainMenuCode.GDProtect_9595BobObjects1= [];
gdjs.MainMenuCode.GDProtect_9595BobObjects2= [];
gdjs.MainMenuCode.GDProtect_9595BobObjects3= [];
...
{for(var i = 0, len = gdjs.MainMenuCode.GDSoundSliderObjects2.length ;i < len;++i) {
    gdjs.MainMenuCode.GDSoundSliderObjects2[i].SetValue(runtimeScene.getGame().getVariables().getFromIndex(0).getChild("Sound").getAsNumber(), null);
}
}
{for(var i = 0, len = gdjs.MainMenuCode.GDMusicSliderObjects2.length ;i < len;++i) {
    gdjs.MainMenuCode.GDMusicSliderObjects2[i].SetValue(runtimeScene.getGame().getVariables().getFromIndex(0).getChild("Music").getAsNumber(), null);
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("Protect_Bob"), gdjs.MainMenuCode.GDProtect_9595BobObjects1);
...
{for(var i = 0, len = gdjs.MainMenuCode.GDProtect_9595BobObjects1.length ;i < len;++i) {
    gdjs.MainMenuCode.GDProtect_9595BobObjects1[i].setCenterXInScene(0.5 * gdjs.evtTools.camera.getCameraWidth(runtimeScene, "", 0));
}
...
{runtimeScene.getGame().getVariables().getFromIndex(0).getChild("Sound").setNumber((( gdjs.MainMenuCode.GDSoundSliderObjects1.length === 0 ) ? 0 :gdjs.MainMenuCode.GDSoundSliderObjects1[0].Value(null)));
}
}
...
{runtimeScene.getGame().getVariables().getFromIndex(0).getChild("Music").setNumber((( gdjs.MainMenuCode.GDMusicSliderObjects1.length === 0 ) ? 0 :gdjs.MainMenuCode.GDMusicSliderObjects1[0].Value(null)));
}
}
...
gdjs.MainMenuCode.GDProtect_9595BobObjects1.length = 0;
gdjs.MainMenuCode.GDProtect_9595BobObjects2.length = 0;
gdjs.MainMenuCode.GDProtect_9595BobObjects3.length = 0;
